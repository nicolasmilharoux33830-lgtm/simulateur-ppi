...
export const metadata: Metadata = {
  ...
  description: "Maquette de démonstration — Plateforme d'attractivité économique de la Communauté d'Agglomération d'Aire-sur-l'Adour. Foncier, aides, implantation.",
