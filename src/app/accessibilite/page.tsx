      ...
      <div className="space-y-8">
        ...
        <Card className="p-6">
          ...
          <div className="mt-4 p-3 bg-paper rounded-lg text-xs text-ink/50">
            En cas de non-réponse dans un délai de 2 jours ouvrables, vous pouvez saisir le <a href="https://www.defenseurdesdroits.fr" target="_blank" rel="noopener noreferrer" className="text-moss underline">Défenseur des droits</a>.
          </div>
        </Card>
